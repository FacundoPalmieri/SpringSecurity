...
public class RoleService implements IRoleService {
     ...
     * @throws DataBaseException Si ocurre un error de acceso a la base de datos o de transacción.
     * @throws BadRequestException Si alguno de los roles no existe en el sistema.
     */
    @Override
    ...
    /**
     * Valída que el rol especificado no exista en la base de datos.
     ...
     * </p>
     *
     * @param roleNew  no exista ya en la base de datos.
     *      * <p>El nombre del rol a validar.
