...
/*
    ...
    public Permission save(Permission permission) {
        try {
            ...
            throw new DataBaseException(e,"PermissionService", permission.getId(), permission.getPermission(), "save");
    ...
    public Permission update(Permission permission) {
        try{
            ...
            throw new DataBaseException(e,"PermissionService", permission.getId(), permission.getPermission(), "update");
        }
    }
