...
public class GlobalExceptionHandler {
     ...
     * </p>
     *
     * @param ex La excepción {@link AppException} que representa un error de recurso no encontrado o un manejador no encontrado.
    ...
    public ResponseEntity<Response<Void>> handleNotFound(AppException ex) {
     ...
     * </p>
     *
     * @param e La excepción {@link AppException} que representa un error inesperado que ocurrió en el sistema.
