 ...
 * </p>
 */
public class RefreshTokenConfigNotFoundExcepetion extends RuntimeException {
  ...
  public RefreshTokenConfigNotFoundExcepetion(Long id, String entityType, String operation) {
